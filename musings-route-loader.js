...
(async function () {
  ...
  try {
    const response = await fetch('/musings.html?v=20260827-musing08', { cache: 'no-cache' });
    ...
    loadStyle('/musing08.css?v=20260827c');
    ...
    await loadScript('/musing08-image.js?v=20260827a');
  } catch (error) {
    console.error(error);
    if (loader) {
